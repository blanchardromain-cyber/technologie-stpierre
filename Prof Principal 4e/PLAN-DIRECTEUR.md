...
- **Étapes suivantes** — déploiement Hub + PSC1 + Carnet par le prof (guides fournis, feu vert chef à obtenir) · photos à déposer dans `donnees/photos/` · séances HVC 🟪 à la demande.
